...
export function Navbar() {
  ...
  return (
    <>
      {/* ── Banner: full-bleed sign board, deliberately outside <header> so it
          scrolls away. A sticky element is bounded by its parent, so nesting
          the bar below inside a ~490px header stopped it pinning at all. ── */}
      <div className="w-full bg-white">
        <Link to="/" className="block w-full" aria-label="Govt. Thirumagal Mills College — home">
          <img
      ...
      {/* ── Sticky bar: contact details and navigation stay put on scroll. ── */}
      <header
