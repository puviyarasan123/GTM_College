...
const HIGHLIGHTS = [
  { k: "98.4%", v: "Placement rate, batch 2024" },
  { k: "₹54 LPA", v: "Highest package offered" },
  { k: "₹12.6 LPA", v: "Average CTC" },
  { k: "450+", v: "Recruiting partners" },
];

const OFFERS = [
  { co: "Google", role: "Software Engineer", ctc: "₹54 LPA" },
  { co: "Microsoft", role: "Product Engineer", ctc: "₹42 LPA" },
  { co: "Amazon", role: "SDE I", ctc: "₹38 LPA" },
  { co: "Goldman Sachs", role: "Technology Analyst", ctc: "₹28 LPA" },
  { co: "JP Morgan", role: "Quant Developer", ctc: "₹26 LPA" },
  { co: "Adobe", role: "MTS — Engineering", ctc: "₹32 LPA" },
];
...
export const Route = createFileRoute("/placement")({
  ...
  component: () => (
    <>
      <PageHero eyebrow="Career outcomes" title="Where our graduates go next." subtitle="A career services team of 22, year-round recruitment drives, and one of the most diverse recruiter pools in the country." />
      <Section>
        ...
        <SectionHeader eyebrow="Our recruiters" title="450+ companies. Every sector." />
