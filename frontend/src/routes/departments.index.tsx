...
export const Route = createFileRoute("/departments/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore the departments at GTM College of Arts & Science — Science, Arts, Commerce & Management." },
  ...
  component: () => (
    <>
      <PageHero
        ...
        title="Twelve departments. One culture of excellence."
        subtitle="Each department is dedicated to quality teaching, student mentorship and academic growth across Science, Arts, Commerce and Management — affiliated to Bharathiar University."
      />
      <Section>
        <SectionHeader title="Our Departments" desc="UG and PG programmes across Science, Arts, Commerce and Management." />
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {DEPARTMENTS.map((d, i) => {
            const Icon = (Icons as unknown as Record<string, React.ElementType>)[d.icon] ?? Icons.GraduationCap;
            return (
              <Reveal key={d.code} delay={i * 0.04}>
                <div className="group relative rounded-2xl border border-border bg-card p-6 h-full overflow-hidden hover:border-primary/30 transition-all hover:shadow-elegant">
                  ...
                  <div className="size-12 rounded-xl bg-gradient-to-br from-primary to-primary-deep text-primary-foreground grid place-items-center mb-5">
